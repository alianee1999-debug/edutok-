...
// ⚠️ تنبيه: "llama-3.3-70b" لم يعد متاحاً على الخطة العامة لـCerebras (صار حصراً عبر
// Dedicated Endpoints بتسعير مخصص). الموديلات المتاحة فعلياً على الخطة العامة حالياً:
// "gpt-oss-120b" (الأقوى والمعتمد للإنتاج)، "llama3.1-8b"، "qwen-3-235b-a22b-instruct-2507".
