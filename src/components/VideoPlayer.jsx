...
@keyframes explainIconGlow{0%,100%{box-shadow:0 0 8px 2px rgba(129,140,248,0.5)}50%{box-shadow:0 0 16px 6px rgba(129,140,248,0.85)}}
    ...
    >
      ...
      {slideIdx===total-1 && total>0 && (
        <button
          ...
          title="اشرحلي بكلامك"
          style={{
            position:"absolute",left:"10px",bottom:"88px",zIndex:15,
            width:"36px",height:"36px",borderRadius:"50%",border:"none",
            background:"linear-gradient(135deg,#4f46e5,#818cf8)",
            display:"flex",alignItems:"center",justifyContent:"center",
            fontSize:"16px",cursor:"pointer",padding:0,
            animation:"explainIconGlow 2.4s ease-in-out infinite",
          }}
        >🧠</button>
      )}
      {showExplain && (
