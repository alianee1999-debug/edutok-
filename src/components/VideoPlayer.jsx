...
const AnimatedSlides = ({video, playing, onClick, ts, slideIdx, setSlideIdx, fontSize="medium"}) => {
  ...
  const handleQuizDragMove = (e) => {
    ...
    let x = e.clientX - rect.left - dragInfo.current.offsetX;
    let y = e.clientY - rect.top - dragInfo.current.offsetY;
    ...
    >
      ...
      {sl.question&&(
        <button
          ...
          onPointerDown={beginQuizDrag}
          onPointerMove={handleQuizDragMove}
          onPointerUp={endQuizDrag}
          onPointerCancel={endQuizDrag}
          title="سؤال سريع"
          style={{
            position:"absolute",
