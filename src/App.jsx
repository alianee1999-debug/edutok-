      ...
      {screen==="home"&&(
        <div onTouchStart={handleTouchStart} onTouchEnd={handleTouchEnd} onTouchMove={handleTouchMove} style={{userSelect:"none",overscrollBehavior:"none"}}>
          ...
          <div style={{padding:"0 20px",marginTop:"10px"}}>
            ...
            {role==="student" && video.subject && renderSubBanner(mySubscriptions, video.subject, video.stage, setModal)}
          ...
          <div style={C.section}>
            ...
            {adminTab==="clips"&&showClipForm&&(
              <div>
                ...
                <button style={{width:"100%",padding:"11px",backgroundColor:"#27272a",color:"#ef4444",border:"1px solid rgba(239,68,68,
