...
export default function App() {
  ...
  // دالة لتشغيل ميزات الأزرار وإشعار المستخدم بأنها تعمل برمجياً
  const handleActionClick = (actionName) => {
    alert(`🎯 تم تشغيل ميزة: [${actionName}] بنجاح!`);
  };
    ...
    <div style={styles.container}>
      ...
      {currentScreen === "home" && (
        <div>
          <div style={styles.videoWrapper}>
            {/* القائمة الجانبية المستديرة العائمة - الآن مفعلة بالكامل عند الضغط */}
            <div style={styles.sidebarActions}>
              <button style={styles.sidebarCircle} onClick={() => handleActionClick("حفظ المقطع للمفضلة")}>
                <span style={{fontSize:"18px"}}>📌</span>
                <span style={styles.sidebarCircleText}>حفظ</span>
              </button>
              <button style={styles.sidebarCircle} onClick={() => handleActionClick("مشاركة رابط الدرس")}>
                <span style={{fontSize:"18px"}}>📥</span>
                <span style={styles.sidebarCircleText}>مشاركة</span>
              </button>
              <button style={styles.sidebarCircle} onClick={() => handleActionClick("فتح معلم الذكاء الاصطناعي")}>
                <span style={{fontSize:"18px"}}>🤖</span>
                <span style={styles.sidebarCircleText}>مساعد</span>
              </button>
              <button style={styles.sidebarCircle} onClick={() => handleActionClick("فتح شات مناقشة الطلاب")}>
                <span style={{fontSize:"18px"}}>💬</span>
                <span style={styles.sidebarCircleText}>طالب</span>
              </button>
              <button style={styles.sidebarCircle} onClick={() => handleActionClick("عرض المزيد من الخيارات")}>
            ...
            {/* زر تشغيل الفيديو */}
            <div style={styles.playButtonCenter} onClick={() => handleActionClick("تشغيل / إيقاف مقطع الفيديو التعليمي")}>
      ...
      {currentScreen === "admin" && (
        <div>
          <div style={styles.topTabsContainer}>
            ...
            <button style={{...styles.topTabButton, backgroundColor: "#27272a"}} onClick={() => handleActionClick("عرض الشرائح الإعلانية")}>✨ شرائح</button>
            <button style={{...styles.topTabButton, backgroundColor: "#27272a"}} onClick={() => handleActionClick("تعديل ملفات المقاطع")}>🎬 المقاطع</button>
          </div>
              ...
              <div>
                ...
                <div style={styles.priceRowCard}>
                  ...
                  <div style={styles.priceInputWrapper}>
                    <input type="text" placeholder="حدد السعر" style={styles.priceInput} onChange={() => {}} />
            ...
            {adminTab === "notifications" && (
              <div>
                ...
                <div style={styles.gridTemplates}>
                  <div style={styles.templateCard} onClick={() => handleActionClick("اختيار قالب: انتهاء الاشتراك")}>انتهاء الاشتراك</div>
                  <div style={styles.templateCard} onClick={() => handleActionClick("اختيار قالب: مقطع جديد")}>مقطع جديد</div>
                  <div style={styles.templateCard} onClick={() => handleActionClick("اختيار قالب: تذكير بالدراسة")}>تذكر بالدراسة</div>
                  <div style={styles.templateCard} onClick={() => handleActionClick("اختيار قالب: عرض خاص")}>عرض خاص</div>
                </div>
                ...
                <button style={styles.largeGradientBtn} onClick={() => handleActionClick("إرسال الإشعار لجميع الهواتف")}>
            ...
            {adminTab === "settings" && (
              <div>
                ...
                <div style={{borderTop: "1px solid rgba(255,255,255,0.05)", paddingTop: "15px"}}>
                  ...
                  <button style={styles.blueActionButton} onClick={() => handleActionClick("حفظ رقم الهاتف الجديد للمدير")}>تغيير رقم الهاتف</button>
                  ...
                  <button style={styles.redActionButton} onClick={() => handleActionClick("تحديث كلمة المرور الجديدة للمدير")}>تغيير كلمة المرور</button>
                </div>
      ...
      {currentScreen === "account" && (
        <div style={{padding: "40px 20px", textAlign: "center"}}>
          ...
          <button style={styles.blueActionButton} onClick={() => handleActionClick("تسجيل الخروج من الحساب")}>تسجيل خروج</button>
        </div>
      )}
