...
export default function App() {
  ...
  useEffect(()=>{
    if(role!=="student"||!currentStudent?.phone){setStudentProgress({});return;}
    const unsub=onSnapshot(doc(db,"progress",currentStudent.phone),snap=>{
      if(snap.exists()) setStudentProgress(snap.data().progress||{});
  ...
  // حفظ تقدم الطالب عند مشاهدة مقطع من مادة مشترك بها
