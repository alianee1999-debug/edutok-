...
function BrowseModal({onClose, clips, globalPrices, onBrowse}) {
  ...
  const availableSubjects = React.useMemo(()=>{
    ...
    const subjs=new Set();
    clips.forEach(c=>{ if(c.stage===selStage&&(c.grade===selGrade||!c.grade)) subjs.add(c.subject); });
    return [...subjs].sort();
  ...
  const availableTopics = React.useMemo(()=>{
    ...
    clips.forEach(c=>{ if(c.stage===selStage&&(c.grade===selGrade||!c.grade)&&c.subject===selSubject&&c.topic) topics.add(c.topic); });
    return [...topics].sort();
    ...
    {step==="subject"&&<div>
      ...
      {availableSubjects.length===0
        ...
        :availableSubjects.map(subj=>{
          ...
          const count=clips.filter(c=>c.stage===selStage&&(c.grade===selGrade||!c.grade)&&c.subject===subj).length;
