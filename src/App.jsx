...
// ─── MISTRAL AI (عبر السيرفر، المفتاح غير مكشوف بالمتصفح) ──
// مجاني بالكامل بدون بطاقة بنكية (رصيد شهري كبير جداً). الموديل النصي فقط،
// نفس منطق الصورة المتجاهلة تلقائياً بالسيرفر (راجع api/mistral.js)
const callMistral = async (prompt, imageBase64=null, imageMime="image/jpeg") => {
  ...
  if(d.error) throw new Error(d.error||"خطأ بالاتصال بـ Mistral");
  return d.text || "";
};
...
const AI_PROVIDERS = [
  ...
  { name: "Mistral",  fn: callMistral,  supportsImage: false },
