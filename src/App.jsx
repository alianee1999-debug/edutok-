...
const AnimatedSlides = ({video, playing, onClick, ts, slideIdx, setSlideIdx, fontSize="medium"}) => {
  ...
  return (
    ...
    >
      ...
      {/* رأس الشريحة — ثابت بموضع مطلق بنفس ارتفاع الهيدر العلوي (الشعار وشارة
          الصف)، عمداً منفصل عن محتوى الشريحة المتحرك بالـfade، عشان يبقى
          بنفس المستوى الأفقي دايماً بغض النظر عن طول نص أي شريحة */}
      <div style={{position:"absolute",top:"12px",left:"18px",right:"18px",zIndex:6,display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
