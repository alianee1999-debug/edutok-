...
function VideoDescriptionModal({onClose,video,role,mySubscriptions,globalPrices,onOpenWallet}) {
...
export default function App() {
  ...
  return (
    <div style={C.app}>
      ...
      {modal==="description" &&<VideoDescriptionModal onClose={closeModal} video={video} role={role} mySubscriptions={mySubscriptions} globalPrices={globalPrices} onOpenWallet={()=>setModal("wallet")}/>}
