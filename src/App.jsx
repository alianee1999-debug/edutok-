    ...
    <div style={C.app}>
            ...
            {adminTab==="settings"&&(
              <div>
                ...
                <div style={C.card}>
                  ...
                  <button style={C.blueBtn} onClick={()=>showMsg("تم!")}>تغيير</button>
                </div>
                <div style={{...C.card,marginTop:"10px"}}>
                  ...
                  <input type="password" placeholder="كلمة المرور الجديدة" style={C.input}/>
                  <button style={C.redBtn} onClick={()=>showMsg("تم!")}>تغيير</button>
                </div>
                ...
                <div style={C.statsGrid}>
                  {[["",clips.length,"المقاطع"],["",students.length,"الطلاب"],["",clips.filter(c=>c.videoUrl).length,"مع فيديو"],["","—","الأرباح"]].map(([icon,num,label])=>(
                    <div key={label} style={C.statCard}>
                      ...
                      <div style={{fontSize:"22px",fontWeight:"bold",color:"#a855f7",margin:"4px 0"}}>{num}</div>
      ...
      {screen==="account"&&(
        <div style={{padding:"40px 20px",textAlign:"center"}}>
          <div style={{width:90,height:90,borderRadius:"50%",background:"linear-gradient(135deg,#0ea5e9,#a855f7)",display:"flex",justifyContent:"center",alignItems:"c
