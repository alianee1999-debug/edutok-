...
// ✅ إعادة هيكلة: هذا المكوّن أصبح مخصصاً حصرياً لتقدّم الفصل الحالي (زر "تقدّمي")
// ولم يعد يحتوي أي محتوى متعلق بالاشتراكات (كان مربوطاً بمادة المقطع الحالي فقط
// ويختفي بالكامل مع المواد المجانية). كل ما يخص الاشتراكات (المحفظة، الكود،
// بوت تيليجرام، وقائمة المواد المشترك بها) انتقل لمكوّن منفصل تماماً اسمه
// SubscriptionDetailsModal (زر "تفاصيل الاشتراك" بقائمة "المزيد")، فأصبح لكل
// زر غرض واضح ومستقل بدل تكرار نفس الشاشة بمعنيين مختلطين.
...
// ─── SUBSCRIPTION DETAILS MODAL (اشتراكاتي، أيامها المتبقية، والمحفظة/الكود/البوت) ───
// مكوّن مستقل بالكامل عن تقدّم أي مقطع محدد — دائم المحتوى بغض النظر عن أي
// شيء تتفرج عليه حالياً (حتى لو مادة مجانية)، فيه كل ما يخص إدارة الاشتراك:
// قائمة المواد المشترك بها + تاريخ انتهاء كل واحدة + تقدّمها، ثم أزرار
// المحفظة/كود التفعيل/بوت تيليجرام/كود الشراكة — تماماً مثل شاشة "حسابي"
// لكن كنافذة سريعة الوصول من داخل تجربة المشاهدة نفسها بدون مغادرتها.
