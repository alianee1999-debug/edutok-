...
function AdminAudioTab() {
  ...
  useEffect(()=>{
    const unsub=onSnapshot(collection(db,"audioTracks"),snap=>{
  ...
  return (
    <div>
      ...
      <div style={{backgroundColor:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"14px",marginBottom:"16px"}}>
        ...
        <ErrBox msg={err}/>
        <button onClick={addTrack} disabled={saving} style={{width:"100%",padding:"10px",borderRadius:"10px",border:"none",backgroundColor:"#38bdf8",color:"#000",fontWeight:"bold",fontSize:"13px",cursor:saving?"default":"pointer",opacity:saving?0.6:1}}>
