...
<body>
<div id="header">
  <span style="color:#38bdf8;font-weight:bold;">App.jsx — 1719 lines</span>
  <div>
          ...
          {allClips.map(clip =&gt; (
            &lt;div key={clip.id} style={{ ...C.card, border: &quot;1px solid rgba(139,92,246,0.2)&quot;, cursor: &quot;pointer&quot; }} onClick={() =&gt; openClip(clip)}&gt;
              &lt;div style={{ display: &quot;flex&quot;, justifyContent: &quot;space-between&quot;, alignItems: &quot;center&quot; }}&gt;
                ...
                &lt;/div&gt;
                &lt;div style={{ backgroundColor: &quot;rgba(139,92,246,0.2)&quot;, border: &quot;1px solid rgba(139,92,246,0.3)&quot;, borderRadius: &quot;8px&quot;, padding: &quot;6px 12px&quot;, color: &quot;#a855f7&quot;, fontSize: &quot;12px&quot;, fontWeight: &quot;bold&quot; }}&gt;
                  تعديل
                &lt;/div&gt;
              &lt;/div&gt;
            &lt;/div&gt;
    ...
    &lt;div&gt;
      ...
      {editIdx !== null ? (
        &lt;div style={{ ...C.card, border: &quot;1px solid rgba(56,189,248,0.2)&quot; }}&gt;
          ...
          &lt;textarea rows={6} value={editPoints} onChange={e =&gt; setEditPoints(e.target.value)}
            style={{ ...C.input, resize: &quot;none&quot; }} placeholder=&quot;نقطة 1&amp;#10;نقطة 2&amp;#10;نقطة 3&quot;/&gt;
          &lt;div style={C.saveRow}&gt;
            &lt;button onClick={() =&gt; setEditIdx(null)} style={C.cancelBtn}&gt;الغاء&lt;/button&gt;
            &lt;button onClick={saveEdit} disabled={saving}
              style={{ ...C.saveBtn, display: &quot;flex&quot;, alignItems: &quot;center&quot;, justifyContent: &quot;center&quot;, gap: &quot;6px&quot;, opacity: saving ? 0.7 : 1 }}&gt;
        ...
        &lt;div style={{ ...C.card, border: &quot;1px solid rgba(34,197,94,0.2)&quot; }}&gt;
          ...
          &lt;label style={C.label}&gt;النقاط (كل نقطة في سطر جديد)&lt;/label&gt;
          &lt;textarea rows={5} value={newPoints} onChange={e =&gt; setNewPoints(e.target.value)}
            style={{ ...C.input, resize: &quot;none&quot; }} placeholder=&quot;نقطة 1&amp;#10;نقطة 2&amp;#10;نقطة 3&quot;/&gt;
          &lt;div style={C.saveRow}&gt;
            &lt;button onClick={() =&gt; setShowAddSlide(false)} style={C.cancelBtn}&gt;الغاء&lt;/button&gt;
            &lt;button onClick={addSlide} disabled={saving}
              style={{ ...C.saveBtn, display: &quot;flex&quot;, alignItems: &quot;center&quot;, justifyContent: &quot;center&quot;, gap: &quot;6px&quot; }}&gt;
          ...
          {confirmDel !== null &amp;&amp; (
            &lt;div style={C.confirmBox}&gt;
              &lt;div style={{ color: &quot;#f87171&quot;, fontWeight: &quot;bold&quot;, marginBottom: &quot;8px&quot; }}&gt;
                هل تريد حذف الشريحة {confirmDel + 1}؟
              &lt;/div&gt;
              &lt;div style={{ display: &quot;flex&quot;, gap: &quot;8px&quot;, justifyContent: &quot;center&quot; }}&gt;
                &lt;button onClick={() =&gt; deleteSlide(confirmDel)}
                  style={{ padding: &quot;8px 20px&quot;, backgroundColor: &quot;#ef4444&quot;, border: &quot;none&quot;, borderRadius: &quot;8px&quot;, color: &quot;#fff&quot;, fontWeight: &quot;bold&quot;, cursor: &quot;pointer&quot; }}&gt;
                  نعم
                &lt;/button&gt;
                &lt;button onClick={() =&gt; setConfirmDel(null)}
                  style={{ padding: &quot;8px 20px&quot;, backgroundColor: &quot;#27272a&quot;, border: &quot;none&quot;, borderRadius: &quot;8px&quot;, color: &quot;#fff&quot;, cursor: &quot;pointer&quot; }}&gt;
                  لا
                &lt;/button&gt;
              &lt;/div&gt;
            &lt;/div&gt;
            ...
            &lt;div key={idx} style={{ ...C.card, border: &quot;1px solid rgba(255,255,255,0.06)&quot; }}&gt;
              &lt;div style={{ display: &quot;flex&quot;, justifyContent: &quot;space-between&quot;, alignItems: &quot;flex-start&quot;, marginBottom: &quot;8px&quot; }}&gt;
                ...
                &lt;div style={{ display: &quot;flex&quot;, flexDirection: &quot;column&quot;, gap: &quot;4px&quot;, marginRight: &quot;8px&quot; }}&gt;
                  &lt;button onClick={() =&gt; moveUp(idx)} disabled={idx === 0}
                    style={{ padding: &quot;4px 8px&quot;, borderRadius: &quot;6px&quot;, border: &quot;none&quot;, backgroundColor: idx === 0 ? &quot;#1c1c1e&quot; : &quot;#27272a&quot;, color: idx === 0 ? &quot;#3f3f46&quot; : &quot;#fff&quot;, cursor: idx === 0 ? &quot;not-allowed&quot; : &quot;pointer&quot;, fontSize: &quot;12px&quot; }}&gt;
                    ↑
                  &lt;/button&gt;
                  &lt;button onClick={() =&gt; moveDown(idx)} disabled={idx === slides.length - 1}
                    style={{ padding: &quot;4px 8px&quot;, borderRadius: &quot;6px&quot;, border: &quot;none&quot;, backgroundColor: idx === slides.length - 1 ? &quot;#1c1c1e&quot; : &quot;#27272a&quot;, color: idx === slides.length - 1 ? &quot;#3f3f46&quot; : &quot;#fff&quot;, cursor: idx === slides.length - 1 ? &quot;not-allowed&quot; : &quot;pointer&quot;, fontSize: &quot;12px&quot; }}&gt;
                    ↓
                  &lt;/button&gt;
                &lt;/div&gt;
              &lt;/div&gt;
              &lt;div style={{ display: &quot;flex&quot;, gap: &quot;8px&quot; }}&gt;
                &lt;button onClick={() =&gt; openEdit(idx)}
                  style={{ flex: 1, padding: &quot;8px&quot;, borderRadius: &quot;8px&quot;, border: &quot;1px solid rgba(56,189,248,0.3)&quot;, backgroundColor: &quot;rgba(56,189,248,0.1)&quot;, color: &quot;#38bdf8&quot;, fontSize: &quot;12px&quot;, fontWeight: &quot;bold&quot;, cursor: &quot;pointer&quot; }}&gt;
                  تعديل
                &lt;/button&gt;
                &lt;button onClick={() =&gt; setConfirmDel(idx)}
                  style={{ flex: 1, padding: &quot;8px&quot;, borderRadius: &quot;8px&quot;, border: &quot;1px solid rgba(239,68,68,0.3)&quot;, backgroundColor: &quot;rgba(239,68,68,0.1)&quot;, color: &quot;#f87171&quot;, fontSize: &quot;12px&quot;, fontWeight: &quot;bold&quot;, cursor: &quot;pointer&quot; }}&gt;
                  حذف
                &lt;/button&gt;
              &lt;/div&gt;
            &lt;/div&gt;
