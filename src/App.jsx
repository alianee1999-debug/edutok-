...
export default function App() {
  ...
  // يحسب رقم المقطع التالي، ويجلب آخر فصل/معلم/موبايل/رقم صفحة مستخدَمة لنفس المادة+المرحلة+الصف
  ...
  const getAutoFillClip = (subject, stage, grade) => {
    ...
    if(similar.length===0) return {num:"01", topic:"", teacher:"", phone:"", page:""};
  ...
  const saveClip=async()=>{
    ...
    try{
      const data={
        ...
        topic:clipTopic,page:clipPage,num:clipNum,teacher:clipTeacher,phone:clipPhone,
