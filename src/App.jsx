...
export default function App() {
  ...
  const [clipPage,setClipPage]=useState(""); const [clipNum,setClipNum]=useState("01");
  ...
  const saveClip=async()=>{
    ...
    try{
      const data={
        ...
        topic:clipTopic,page:clipPage,num:clipNum,teacher:clipTeacher,
          ...
          <div style={C.section}>
            ...
            {adminTab==="clips"&&showClipForm&&(
              <div>
                ...
                <div style={C.twoCol}>
                  <div><label style={C.label}>رقم الصفحة</label><input type="number" value={clipPage} onChange={e=>setClipPage(e.target.value)} style={C.input} placeholder="مثال: 12"/></div>
