  ...
  const allVideos = React.useMemo(()=>{
    ...
    if(selectedSubject){
      ...
      if(selectedSubject.isFree===false){
        // مدفوعة: أول 5 مقاطع بالتسلسل، والباقي عشوائي — لكن **داخل كل فصل لوحده**،
        // مو عشوائي عبر كل المادة دفعة وحدة. لو عمّمنا العشوائية على كل شيء بعد أول 5
        // (زي الكود القديم)، بترجع نفس مشكلة تداخل الفصول ببعضها حتى لو المادة مدفوعة.
