...
export default function App() {
  ...
  const doRegister=async()=>{
    ...
    try{
      ...
      setRegName("");setRegPhone("");setRegAccount("");setRegPass("");setRegStage("الابتدائية");setRegGrade("الأول");setRegAccountType("student");setRegErr("");
    }
