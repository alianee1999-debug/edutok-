...
function CodeModal({onClose,student,mySubscriptions}) {
  ...
  const redeem=async()=>{
    ...
    try{
      ...
      const newExpiry = computeExtendedExpiry(mySubscriptions, data.subject, data.stage, data.durationDays);
      ...
      await addDoc(collection(db,"notifications"),{
        ...
        body:"تم تفعيل/تمديد اشتراكك في "+data.subject+" ("+data.stage+"). ينتهي في "+newExpiry.toLocaleDateString("ar"),
        targetPhone: student.phone,
        sentAt: serverTimestamp(),
      });
      setResult({subject:data.subject,stage:data.stage,newExpiry});
    }catch(e){
