          ...
          <div style={{padding:"0 20px",marginTop:"10px"}}>
            ...
            {role==="student"&&(
              <div style={{display:"flex",justifyContent:"center",marginTop:"14px"}}>
                <button onClick={openNotifications} style={{position:"relative",display:"flex",alignItems:"center",gap:"6px",backgroundColor:"#18181b",border:"1px solid rgba(56,189,248,0.2)",borderRadius:"20px",padding:"8px 16px",color:"#38bdf8",fontSize:"12px",fontWeight:"bold",cursor:"pointer"}}>
                  <Bell size={15}/>
                  الإشعارات
                  {unreadNotifCount>0&&<span style={{position:"absolute",top:"-4px",right:"-4px",backgroundColor:"#ef4444",color:"#fff",borderRadius:"10px",minWidth:"18px",height:"18px",fontSize:"10px",display:"flex",alignItems:"center",justifyContent:"center",padding:"0 4px"}}>{unreadNotifCount>9?"9+":unreadNotifCount}</span>}
                </button>
              </div>
            )}
          </div>
