...
function VideoDescriptionModal({onClose,video,role,mySubscriptions,globalPrices,onOpenWallet,onSelectSubject,videoIdx,totalVideos,clips,watchedClipIds,examScores,progressUpdatedAt,allVideos,onJumpToVideo}) {
    ...
    {chapterInfo&&(
      <div style={{backgroundColor:"rgba(255,255,255,0.03)",border:"1px solid rgba(255,255,255,0.08)",borderRadius:"12px",padding:"12px 14px",marginBottom:"12px"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"8px"}}>
          ...
          <div style={{fontSize:"12px",fontWeight:"900",color:chapterInfo.missingCount===0?"#4ade80":chapterInfo.unlocked?"#38bdf8":"#f87171"}}>
