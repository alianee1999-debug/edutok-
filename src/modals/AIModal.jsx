...
function AIModal({onClose,video,currentSlide,audioTracks,currentTrack,setCurrentTrack,audioPlaying,setAudioPlaying,audioVolume,setAudioVolume,onOpenOnboarding}) {
  ...
  return <div style={C.overlay}><div style={{...C.modalBox,border:"1px solid rgba(56,189,248,0.2)",display:"flex",flexDirection:"column"}}>
    ...
    {/* ✅ إضافة: رابط مرجعي خارجي اختياري (يوتيوب/جوجل) يضيفه المدير لهذا
        المقطع تحديداً — يظهر هنا فقط (جوا مساعد زكي)، منفصل تماماً عن رابط
        الفيديو الأساسي المعروض بالشاشة الرئيسية. يعطي الطالب مصدر إضافي
        للمراجعة لو احتاج شرحاً من مصدر خارجي بجانب شرح زكي نفسه. */}
    {video.referenceLink&&(
      <a href={video.referenceLink} target="_blank" rel="noreferrer" style={{display:"flex",alignItems:"center",gap:"10px",backgroundColor:"rgba(52,211,153,0.08)",border:"1px solid rgba(52,211,153,0.3)",borderRadius:"12px",padding:"10px 12px",marginBottom:"12px",textDecoration:"none"}}>
        <span style={{fontSize:"22px",flexShrink:0}}>📎</span>
        <div style={{flex:1,minWidth:0}}>
          <div style={{fontSize:"12.5px",fontWeight:"bold",color:"#34d399"}}>مرجع إضافي لهذا الدرس</div>
          <div style={{fontSize:"11px",color:"#71717a"}}>اضغط لمشاهدة شرح إضافي بيوتيوب أو جوجل</div>
        </div>
